...
b.search===void 0?true:b.search,d=b.hidden===true;if(b.searchoptions&&b.searchoptions.searchhidden===true&&c||c&&!d){n=true;l=b.index||b.name;x=a}}});if(!o&&l||!1===b.multipleSearch){var A="eq";0<=x&&v[x].searchoptions&&v[x].searchoptions.sopt?A=v[x].searchoptions.sopt[0]:b.sopt&&b.sopt.length&&(A=b.sopt[0]);o={groupOp:"AND",rules:[{field:l,op:A,data:""}]}}n=!1;b.tmplNames&&b.tmplNames.length&&(n=!0,m=b.tmplLabel,m+="<select class='ui-templates'>",m+="<option value='default'>Default</option>",a.each(b.tmplNames,
...
groupButton:b.multipleGroup,ruleButtons:b.multipleSearch,afterRedraw:b.afterRedraw,ops:b.odata,operands:b.operands,ajaxSelectOptions:e.p.ajaxSelectOptions,groupOps:b.groupOps,onChange:function(){this.p.showQuery&&a(".query",this).html(this.toUserFriendlyString());a.isFunction(b.afterChange)&&b.afterChange.call(e,a("#"+h),b)},direction:e.p.direction,id:e.p.id});f.append(i);n&&b.tmplFilters&&b.tmplFilters.length&&a(".ui-templates",f).bind("change",function(){var c=a(this).val();c==="default"?a("#"+h).jqFilter("addFilter",
...
{gb:"#gbox_"+a.jgrid.jqID(e.p.id),jqm:b.jqModal,onClose:b.onClose});return false});a("#"+h+"_reset").bind("click",function(){var c={},d=a("#"+h);e.p.search=false;b.multipleSearch===false?c[b.sField]=c[b.sValue]=c[b.sOper]="":c[b.sFilter]="";d[0].resetFilter();n&&a(".ui-templates",f).val("default");a.extend(e.p.postData,c);r=a(e).triggerHandler("jqGridFilterReset");r===void 0&&(r=true);r&&a.isFunction(b.onReset)&&(r=b.onReset.call(e));r!==false&&a(e).trigger("reloadGrid",[{page:1}]);b.closeAfterReset&&
