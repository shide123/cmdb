...
class AddPhyHostView(View):
    ...
    def post(self, request):
        ...
        if phy_forms.is_valid():
            ...
            phyhost = PhysicalMachine.objects.filter(physicalIp=physicalIp, machineRoom_address=machineRoom_address,
                                                     machineRoom_attr=machineRoom_attr)
    ...
    if request.method == "GET":
        ...
        if phyhost is not None:
            ...
            if machine_info is None:
                machine_info = Machine_info(ipv4=ip4[0], cpu_total=cpu_total, mem_total=mem_total,
                                            cpu_type=cpu_type,
                ...
                machine_info.save()
            return render(request, 'phyhost_forms.html', {'machine_info_input': machine_info})
